...
Promo Dependency Score: Built a continuous metric assigning values (1.0 for full coupon reliance, 0.5 for partial, 0.0 for organic demand) to isolate bargain hunters.
